...
import { LayerData as PrismaLayer } from "@/prisma/generated_schema/Example";
...
const ExpandableLayerGroup = (props: LayerGroupProps) => {
    ...
    const fetchLayerData = async (id: string) => {
        setIsLoading(true);
        try {
            await fetch('/api/examplePage/LayerData/' + id)
            .then((response) => {
    ...
    const moveLayerGroupUp = async (id: string) => {
        setIsLoading(true);
        try {
            await fetch('/api/examplePage/LayerGroup/Rearrange/Up/' + id, {
                method: 'PUT',
                headers: {
    ...
    const moveLayerGroupDown = async (id: string) => {
        setIsLoading(true);
        try {
            await fetch('/api/examplePage/LayerGroup/Rearrange/Down/' + id, {
                method: 'PUT',
                headers: {
                    authorization: props.authToken,
                    "Content-Type": "application/json",
